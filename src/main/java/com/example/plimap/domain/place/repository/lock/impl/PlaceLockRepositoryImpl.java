...
public class PlaceLockRepositoryImpl implements PlaceLockRepository {
    ...
    private static final String ADDRESS_SELECTION_LOCK_PREFIX = "ADDRESS_SELECTION|";
    ...
    @Override
    @Transactional(propagation = Propagation.MANDATORY)
    public void acquireAddressSelectionLock(String normalizedAddress) {
        acquireTextLock(ADDRESS_SELECTION_LOCK_PREFIX + normalizedAddress);
    }
