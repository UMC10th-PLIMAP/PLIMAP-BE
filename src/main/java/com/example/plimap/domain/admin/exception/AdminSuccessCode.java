...
public enum AdminSuccessCode implements BaseSuccessCode {
    ...
    PIN_SANCTION_GRANTED(HttpStatus.OK, "ADMIN_200_PIN_SANCTION_GRANTED", "PIN 신고에 대한 최종 제재가 반영되었습니다."),
    MEMBER_SANCTION_GRANTED(HttpStatus.OK, "ADMIN_200_MEMBER_SANCTION_GRANTED", "프로필 신고에 대한 최종 제재가 반영되었습니다."),
