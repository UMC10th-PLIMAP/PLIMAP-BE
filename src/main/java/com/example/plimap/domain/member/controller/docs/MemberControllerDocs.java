...
public interface MemberControllerDocs {
    ...
    @Operation(
            ...
            description = """
                    ...
                    penaltyPoint는 누적 벌점(절대 리셋되지 않음)이고, lastPenaltyPeriod는 가장 최근 제재 시 적용된 기간(ONE_DAY/THREE_DAYS/FIVE_DAYS/PERMANENT)입니다. 한 번도 제재받은 적 없는 회원은 penaltyPoint가 0, lastPenaltyPeriod가 null입니다.
                    """
    )
